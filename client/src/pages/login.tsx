      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Sign in with your secure OAuth account</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            >
              ...
              {oauthLoading ? "Connecting..." : "Sign in with OAuth"}
            </Button>

            <div className="text-center">
              <p className="text-sm text-muted-foreground">
                Don't have an account?{" "}
                <Button variant="link" onClick={handleOAuthLogin} disabled={oauthLoading}>
                  Sign up with OAuth
                </Button>
              </p>
            </div>
