            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col items-center mb-6">
                <div className="relative">
                  ...
                  <label htmlFor="profile-picture" className="absolute bottom-4 right-0 bg-primary text-primary-foreground rounded-full p-2 cursor-pointer hover:bg-primary/90">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input {...personalForm.register("first_name")} placeholder="First name" />
                </div>
                <div>
                  <Label htmlFor="last_name">Last Name</Label>
                  <Input {...personalForm.register("last_name")} placeholder="Last name" />
                </div>
              </div>
                ...
                <Card key={exp.id} className="p-4">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">{exp.organization_name || "Company"}</p>
                      {(exp.date_started || exp.date_finished) && (
                        <p className="text-xs text-muted-foreground mt-1">
                          {exp.date_started || "Start"} - {exp.date_finished || "Present"}
                        </p>
                      )}
                      {exp.description && (
              ...
              <Card className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <DatePicker
                        ...
                        placeholder="Current job? Leave empty"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2">
                    <Button
                      type="button"
                      onClick={() => handleAddExperience(experienceForm.getValues())}
                    >
                      Add Experience
                    </Button>
                    <Button
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">Add your academic background</p>
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      {(edu.date_started || edu.date_finished) && (
                        <p className="text-xs text-muted-foreground mt-1">
                          {edu.date_started || "Start"} - {edu.date_finished || "Present"}
                        </p>
                      )}
                    </div>
                    <Button
              ...
              <Card className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <DatePicker
                        ...
                        placeholder="Still studying? Leave empty"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2">
                    <Button
                      type="button"
                      onClick={() => handleAddEducation(educationForm.getValues())}
                    >
                      Add Education
                    </Button>
                    <Button
      ...
      <div className="max-w-2xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <div className="mb-6">
            ...
            <Progress value={ONBOARDING_STEPS[currentStep - 1]?.progress} className="h-2" />
          </div>
